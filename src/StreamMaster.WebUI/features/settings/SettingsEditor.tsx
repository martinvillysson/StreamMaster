...
const SettingsEditor = () => {
	...
	const adminUserNameError = useMemo((): string | undefined => {
		if (
			currentSetting?.AuthenticationMethod !== "None" &&
			currentSetting?.AdminUserName === ""
		)
	...
	return (
		<StandardHeader
			displayName={GetMessage("settings")}
