					...
					<div className="stringeditor">
						<div className={getDarkDiv}>
							...
							<div
								...
								ref={
									props.modal === true && props.modalCentered === true
										? undefined
										: props.refs?.setReference
								}
								{...(!buttonDisabled && props.getReferenceProps
			...
			return (
				...
				>
					...
					>
						...
						{props.label && (
							<div
								className={buttonDisabled === true ? "p-disabled" : undefined}
							>
								{props.label}
							</div>
						)}
