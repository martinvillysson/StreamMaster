...
import type { SMDropDownProperties } from "./Interfaces/SMDropDownProperties";
import SMOverlay, { type SMOverlayRef } from "./SMOverlay";
		...
		return (
			<>
				...
				<div className={getDiv}>
					{props.label && labelInline && (
						<div className={labelInline ? "w-5" : "w-12"}>
