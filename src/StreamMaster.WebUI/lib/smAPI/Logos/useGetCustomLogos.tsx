...
interface ExtendedQueryHookResult
	extends QueryHookResult<CustomLogoDto[] | undefined> {}
...
const useGetCustomLogos = (): Result => {
	...
	const isForced = useAppSelector(
		(state) => state.GetCustomLogos.isForced ?? false,
	);
